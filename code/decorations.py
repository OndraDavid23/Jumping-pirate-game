...
class Water:
    def __init__(self, top, leve_width):
        water_start = -screen_width
        water_tile_width = 192
        tile_x_ammount = int((leve_width + screen_width*2) / water_tile_width)
        self.water_sprites = pygame.sprite.Group()

        for tile in range(tile_x_ammount):
...
class Clouds:
    ...
    def draw(self, surface, x_shift):
        self.clouds_sprites.update(x_shift)
